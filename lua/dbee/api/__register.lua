...
return function()
  ...
  vim.fn["remote#host#RegisterPlugin"]("nvim_dbee", "0", {
    ...
    { type = "function", name = "DbeeConnectionGetColumnsAsync", sync = true, opts = vim.empty_dict() },
    { type = "function", name = "DbeeConnectionGetColumnsRichAsync", sync = true, opts = vim.empty_dict() },
    { type = "function", name = "DbeeConnectionGetHelpers", sync = true, opts = vim.empty_dict() },
    { type = "function", name = "DbeeConnectionGetIndexesAsync", sync = true, opts = vim.empty_dict() },
    { type = "function", name = "DbeeConnectionGetParams", sync = true, opts = vim.empty_dict() },
    { type = "function", name = "DbeeConnectionGetRichMetadataSupport", sync = true, opts = vim.empty_dict() },
    { type = "function", name = "DbeeConnectionGetSequencesAsync", sync = true, opts = vim.empty_dict() },
    ...
    { type = "function", name = "DbeeConnectionTestDetailed", sync = true, opts = vim.empty_dict() },
    { type = "function", name = "DbeeConnectionTestSpec", sync = true, opts = vim.empty_dict() },
    ...
    { type = "function", name = "DbeeOracleWalletCacheClear", sync = true, opts = vim.empty_dict() },
    { type = "function", name = "DbeeOracleWalletSetAutoExtract", sync = true, opts = vim.empty_dict() },
