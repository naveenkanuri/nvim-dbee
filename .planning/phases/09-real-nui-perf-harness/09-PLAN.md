...
DRAW01_LINUX_PERF_THRESHOLD_INITIAL_RENDER_MEDIAN_MS=<float>
DRAW01_LINUX_PERF_THRESHOLD_INITIAL_RENDER_P95_MS=<float>
DRAW01_LINUX_PERF_THRESHOLD_FILTER_FIRST_REDRAW_MEDIAN_MS=<float>
DRAW01_LINUX_PERF_THRESHOLD_FILTER_FIRST_REDRAW_P95_MS=<float>
DRAW01_LINUX_PERF_THRESHOLD_FILTER_STABLE_MEDIAN_MS=<float>
DRAW01_LINUX_PERF_THRESHOLD_FILTER_STABLE_P95_MS=<float>
DRAW01_LINUX_PERF_THRESHOLD_LAZY_EXPAND_MEDIAN_MS=<float>
DRAW01_LINUX_PERF_THRESHOLD_LAZY_EXPAND_P95_MS=<float>
DRAW01_LINUX_PERF_THRESHOLD_CACHED_EXPAND_MEDIAN_MS=<float>
DRAW01_LINUX_PERF_THRESHOLD_CACHED_EXPAND_P95_MS=<float>
DRAW01_LINUX_PERF_THRESHOLD_LOAD_MORE_MEDIAN_MS=<float>
DRAW01_LINUX_PERF_THRESHOLD_LOAD_MORE_P95_MS=<float>
DRAW01_LINUX_PERF_THRESHOLD_PASS=true|false

DRAW01_MACOS_PERF_THRESHOLD_INITIAL_RENDER_MEDIAN_MS=<float>
DRAW01_MACOS_PERF_THRESHOLD_INITIAL_RENDER_P95_MS=<float>
DRAW01_MACOS_PERF_THRESHOLD_FILTER_FIRST_REDRAW_MEDIAN_MS=<float>
DRAW01_MACOS_PERF_THRESHOLD_FILTER_FIRST_REDRAW_P95_MS=<float>
DRAW01_MACOS_PERF_THRESHOLD_FILTER_STABLE_MEDIAN_MS=<float>
DRAW01_MACOS_PERF_THRESHOLD_FILTER_STABLE_P95_MS=<float>
DRAW01_MACOS_PERF_THRESHOLD_LAZY_EXPAND_MEDIAN_MS=<float>
DRAW01_MACOS_PERF_THRESHOLD_LAZY_EXPAND_P95_MS=<float>
DRAW01_MACOS_PERF_THRESHOLD_CACHED_EXPAND_MEDIAN_MS=<float>
DRAW01_MACOS_PERF_THRESHOLD_CACHED_EXPAND_P95_MS=<float>
DRAW01_MACOS_PERF_THRESHOLD_LOAD_MORE_MEDIAN_MS=<float>
DRAW01_MACOS_PERF_THRESHOLD_LOAD_MORE_P95_MS=<float>
DRAW01_MACOS_PERF_THRESHOLD_PASS=true|false

DRAW01_REAL_NUI_PERF_ALL_PASS=true|false
```
