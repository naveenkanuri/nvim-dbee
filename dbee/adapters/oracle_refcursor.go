...
func (d *oracleDriver) executePLSQLWithCursor(ctx context.Context, query string, binds map[string]string) (core.ResultStream, error) {
	...
	output, err := d.fetchDBMSOutputFromConn(ctx, rawConn)
	if err != nil {
		rawConn.Close()
