...
print("ARCH14_ADAPTER_ORACLE_PUSHDOWN_PER_ARM_OK=true")
...
print("ARCH14_ADAPTER_POSTGRES_PUSHDOWN_PER_ARM_OK=true")
...
print("ARCH14_ADAPTER_MYSQL_PUSHDOWN_PER_ARM_OK=true")
...
print("ARCH14_ADAPTER_MSSQL_PUSHDOWN_PER_ARM_OK=true")
