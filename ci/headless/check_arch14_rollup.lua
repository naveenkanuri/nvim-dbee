...
local required_true_markers = {
  ...
  "ARCH14_FAIL_CLOSED_REJECTS_SCHEMA_LESS",
  "ARCH14_LAZY_REQUIRES_INCLUDE",
  "ARCH14_AUTHORITY_HELPER_PRESENT",
  "ARCH14_AUTHORITY_HELPER_FAIL_CLOSED_API",
  "ARCH14_AUTHORITY_HELPER_LEGACY_API",
  "ARCH14_AUTHORITY_HELPER_OK_API",
  "ARCH14_AUTHORITY_HELPER_ALL_CONSUMERS_ROUTED",
  "ARCH14_FILTER_CLEAR_NO_STALE",
  "ARCH14_FILTER_CLEAR_STRIP_META_OK",
  ...
  "ARCH14_LIST_SCHEMAS_FAIL_CLOSED_ON_AUTHORITY_NIL",
  ...
  "ARCH14_SCHEMA_OBJECTS_PAYLOAD_FILTERED",
  ...
  "ARCH14_ADAPTER_ORACLE_PUSHDOWN_SHAPE_OK",
  "ARCH14_ADAPTER_POSTGRES_PUSHDOWN_SHAPE_OK",
  "ARCH14_ADAPTER_MYSQL_PUSHDOWN_SHAPE_OK",
  "ARCH14_ADAPTER_MSSQL_PUSHDOWN_SHAPE_OK",
  "ARCH14_ADAPTER_ALL_PASS",
  "ARCH14_SCHEMA_ONLY_ROOT_FAST",
  "ARCH14_SCHEMA_BRANCH_LAZY_OK",
  "ARCH14_SCHEMA_BRANCH_ERROR_RETRY_OK",
  "ARCH14_DRAWER_AUTHORITY_UNAVAILABLE_NOT_CACHED_SUCCESS",
  ...
  "ARCH14_FILTER_DELETION_EAGER_PATH_OK",
  ...
  "ARCH14_LSP_PROBE_SCOPE_OK",
  "ARCH14_LSP_CACHE_FAIL_CLOSED_ON_AUTHORITY_NIL",
  "ARCH14_LSP_STARTUP_AUTHORITY_NIL_NO_METADATA_SQL",
  "ARCH14_LSP_ACTIVE_CACHE_FAIL_CLOSED_ON_AUTHORITY_NIL",
  "ARCH14_FILTER_AUTHORITY_SINGLE_SOURCE_OK",
  "ARCH14_FILTER_AUTHORITY_FAIL_CLOSED_ON_NIL_PARAMS",
  "ARCH14_SYNC_SCHEMA_OBJECTS_FILTERED",
  "ARCH14_COLUMN_CACHE_CORRUPTION_WARN_RETAINED",
  ...
  "ARCH14_LSP_TRANSPORT_FAIL_TRUTHFUL",
  ...
  "ARCH14_RECONNECT_SCHEMA_SCOPE_EQUALITY",
