...
assert_absent("code actions no direct schema filter source", code_actions_text, "get_schema_filter_normalized%(")
assert_absent("context helpers no direct schema filter source", context_code_action_text, "get_schema_filter_normalized%(")
assert_absent("server route no direct schema filter source", server_code_action_text, "get_schema_filter_normalized%(")
assert_absent("init callbacks no direct schema filter source", init_command_text, "get_schema_filter_normalized%(")
assert_absent("schema cache reload no direct schema filter source", reload_helper_text, "get_schema_filter_normalized%(")
