...
assert_contains("oracle table owner scope", oracle, "i.table_owner = :p_schema")
assert_true("oracle does not scope by index owner", not oracle:find("WHERE i.owner = :p_schema", 1, true))
